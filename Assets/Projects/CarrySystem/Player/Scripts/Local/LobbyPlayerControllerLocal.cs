...
{
    // CarryPlayerControllerLocal.csをコピペ
    // AbstractNetworkPlayerControllerのローカル版に当たる抽象クラスは作成していない
    [RequireComponent(typeof(Rigidbody))]
    public class LobbyPlayerControllerLocal : MonoBehaviour , IPlayerController
    {
