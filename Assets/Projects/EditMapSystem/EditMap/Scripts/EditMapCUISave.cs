...
namespace Carry.EditMapSystem.EditMap.Scripts
{
    public class EditMapCUISave : MonoBehaviour
    {
        ...
        async void SaveProcess()
        {
            ...
            _entityGridMapSaver.SaveMap(_editMapSwitcher.GetMap(), _key, _index);
        ...
        {
            // オートセーブはインデックス0に保存する
            _entityGridMapSaver.SaveMap(_editMapSwitcher.GetMap(), _key, 0);
        ...
        void SaveDefaultMap()
        {
            ...
            var clearedMap = _editMapSwitcher.GetMap().ClearMap();
