    ...
    public class EntityGridMapBuilder : IEntityGridMapBuilder
    {
        public EntityGridMap BuildEntityGridMap(EntityGridMapData gridMapData)
        {
            ...
            for (int i = 0; i < map.Length; i++)
            {
                ...
                AddEntityFromRecord<TreasureCoinBlock, TreasureCoinRecord, TreasureCoinBlock.Kind>(gridMapData.treasureCoinRecords, () => gridMapData.treasureCoinRecords?.Length ?? 0, (record) => record.kinds, TreasureCoinBlock.Kind.None, map, i );
