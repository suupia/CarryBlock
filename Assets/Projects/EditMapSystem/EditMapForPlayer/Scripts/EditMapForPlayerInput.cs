...
namespace Carry.EditMapSystem.EditMapForPlayer.Scripts
{
    public class EditMapForPlayerInput : MonoBehaviour
    {
        ...
        [Inject]
        public void Construct(MemorableEditMapBlockAttacher editMapBlockAttacher, IMapGetter editMapGetter)
        {
        ...
        void GetInput()
        {
            ...
            {
                _editMapBlockAttacher.Undo(_editMapGetter.GetMap());
            }

            // Redo
            if (Input.GetKeyDown(KeyCode.M))
            {
                _editMapBlockAttacher.Redo(_editMapGetter.GetMap());
            }
