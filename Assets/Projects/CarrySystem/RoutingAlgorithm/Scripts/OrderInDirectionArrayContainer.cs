...
namespace Carry.CarrySystem.RoutingAlgorithm.Scripts
{
    public static class OrderInDirectionArrayContainer
    {
        ...
        // 8 * 1
        // 7 5 3 の優先順位で判定していく
        public static Vector2Int[] CounterClockwiseStartingRightDirections = new Vector2Int[]
        {
        ...
        // 8 * 1
        // 6 4 2 の優先順位で判定していく
        public static Vector2Int[] ClockwiseStartingRightDirections = new Vector2Int[]
        {
        ...
        // 7 * 2
        // 5 3 1 の優先順位で判定していく
        public static Vector2Int[] CounterClockwiseStartingRightDownDirections = new Vector2Int[]
        {
        ...
        // 6 * 3
        // 4 2 1 の優先順位で判定していく
        public static Vector2Int[] ClockwiseStartingRightDownDirections = new Vector2Int[]
        {
        ...
        // 2 * 7
        // 4 6 8 の優先順位で判定していく
        public static Vector2Int[] CounterClockwiseStartingLeftUpDirections = new Vector2Int[]
        {
        ...
        // 3 * 6
        // 5 7 8 の優先順位で判定していく
        public static Vector2Int[] ClockwiseStartingLeftUpDirections = new Vector2Int[]
        {
